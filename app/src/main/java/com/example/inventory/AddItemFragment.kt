...
class AddItemFragment : Fragment() {
    ...
    private fun bind(item: Item) {
        ...
        binding.apply {
            ...
            itemBrand.setText(item.itemBrand, TextView.BufferType.SPANNABLE)
            itemCategory.setText(item.itemCategory, TextView.BufferType.SPANNABLE)
            itemImage.setText(item.itemImage, TextView.BufferType.SPANNABLE)
    ...
    //validar (itemName.isBlank() en inventoryviewmodel
    ...
    private fun updateItem() {
        if (isEntryValid()) {
            viewModel.updateItem(
                ...
                this.binding.itemBrand.text.toString(),
                this.binding.itemCategory.text.toString(),
                this.binding.itemImage.text.toString(),
